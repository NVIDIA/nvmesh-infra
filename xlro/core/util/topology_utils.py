...
if __name__ == '__main__':
    ...
    topos = ClientVolumeTopology.get_volume_topologies(args.client, args.volume, args.start_time, args.end_time)
    json.dump([topo.to_dict() for topo in topos], sys.stdout, indent=2)
